...
def get_method(method_name, model, outlier_detection, X_train, Y_train, dataset):
    ...
    if method_name == "p2ce_deep_abs_diff":
    ...
    elif method_name == "mapocam_deep_abs_diff":
        action_set = get_action_set(dataset, X_train, default_step_size=0.05)
    ...
    elif method_name == "p2ce_deep_multi":
        action_set = get_action_set(dataset, X_train, default_step_size=0.05)
    ...
    elif method_name == "mapocam_deep_multi":
        action_set = get_action_set(dataset, X_train, default_step_size=0.05)
...
def run(dataset_name, method_name, n_samples=500):
    ...
    run_experiments(
        ...
        model=model_wrap,
        output_file=f"../results/mlp/{dataset}/{method_name}.csv",
    )
